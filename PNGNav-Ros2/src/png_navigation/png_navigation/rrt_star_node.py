...
from png_navigation.tools.path_planning_classes.rrt_star_2d import get_path_planner
...
def main(args=None):
    ...
    try:
        ...
        rrtsn.get_logger().info('Node stopped cleanly')
    except Exception as e:
        rrtsn.get_logger().error(f'Exception in node: {e}')
    finally:
        rrtsn.destroy_node()
        rclpy.shutdown()
