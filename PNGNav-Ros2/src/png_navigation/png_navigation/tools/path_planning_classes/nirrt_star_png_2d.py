...
from png_navigation.tools.path_planning_classes.irrt_star_2d import IRRTStar2D
from png_navigation.tools.path_planning_classes.rrt_visualizer_2d import NIRRTStarVisualizer
...
class NIRRTStarPNG2D(IRRTStar2D, Node):
    def __init__(
        self,
        x_start,
        x_goal,
